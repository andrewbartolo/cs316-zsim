...
TEMP=`getopt -l 'l1size:,l2size:,l1ways:,l2ways:,l3size:,l3repl:,l3ways:,l3model:,memranks:,memtech:' -o 'ha:c:f:t:b:BS' -- "$@"`
...
case "$APPLICATION" in
    blackscholes)  CMD="process0 = { command = \"$APP_PATH/blackscholes/blackscholes $THREADS 100\"; startFastForwarded = True; };" ;;
...
#    canneal)       CMD="$APP_PATH/canneal/canneal $THREADS 16384 2000 2500000.bnets 10000" ;;
    ...
    fluidanimate)  CMD="process0 = { command = \"$APP_PATH/fluidanimate/fluidanimate 8 5 $INDIR/in_300K.fluid out.fluid\"; startFastForwarded = True; };" ;;
...
TAG="${APPLICATION}_${BINARY}_${CORES}_${THREADS}_${FREQUENCY}_L1_${L1SIZE}_${L1WAYS}_L2_${L2SIZE}_${L2WAYS}_L3_${L3SIZE}_${L3WAYS}_${L3REPL}_${L3MODEL}_MEMRANKS_${MEMRANKS}_${MEMTECH}"
...
/afs/ir/class/cs316/pa1/zsim_github/build/opt/zsim zsim.cfg; /afs/ir/class/cs316/pa1/bin/stats_test.sh | tee stats.txt
