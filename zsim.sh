...
Usage: zsim.sh [options]
   ...
   -a <APPLICATION>    (blackscholes, ferret, streamcluster, swaptions, art, mix)
...
#    canneal)       CMD="$APP_PATH/canneal/canneal $THREADS 16384 2000 2500000.bnets 10000" ;;
    ...
    freqmine)  CMD="process0 = { command = \"$APP_PATH/freqmine/freqmine $INDIR/T10I4D100K_1k.dat 100 out.freqmine\"; startFastForwarded = True; };" ;;
    ferret)  CMD="process0 = { command = \"$APP_PATH/ferret/ferret $INDIR/corel lsh $INDIR/queries 10 20 $THREADS output.txt\"; startFastForwarded = True; };" ;;
